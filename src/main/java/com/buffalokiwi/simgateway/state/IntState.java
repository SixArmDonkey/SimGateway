 ...
 * @author John Quinn
 */
public class IntState extends VariableState<Integer>
{
  public IntState( final ISimControl control, final IStateEventManager stateEventManager )
  {
    super( control, stateEventManager, 0 );
  }
}
